...
(function($, window, document, Math, undefined) {
    ...
    $.fn.fullpage = function(options) {
        ...
        */
         ...
         * 20150403
         */
        FP.setFooterAuto = function(){
            // console.log(SECTION_DEFAULT_SEL.length);
            $(SECTION_LAST_SEL).css("height" , "500px");
            $(SECTION_LAST_SEL).find(TABLE_CELL_SEL).css("height" , "500px")
        }
        ...
        */
        function scrollPage(element, callback, isMovementUp){
            ...
            var _top = dest.top,
                _winH = $(window).height();
            if(element.index() == $(SECTION_DEFAULT_SEL).length - 1){
                // console.log("footer");
                _top =  _top - (_winH - 500) ;
            }

            // console.log(dest.top, _winH);
