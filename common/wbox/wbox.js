...
(function($){
    ...
    $.fn.wBox = function(options){
        ...
        var  wBoxHtml = '<div id="wBox"><div class="wBox_popup"><table><tbody><tr><td class="wBox_tl"/><td class="wBox_b"/><td class="wBox_tr"/></tr><tr><td class="wBox_b"><div style="width:10px;">&nbsp;</div></td><td><div class="wBox_body">' + (_this.YQ.noTitle ? '' : '<table class="wBox_title '+(_this.YQ.titleBg ? 'wBox_titleBg' : '')+'"><tr><td class="wBox_dragTitle"><div class="wBox_itemTitle">' + _this.YQ.title + '</div></td><td width="25px" title="关闭"><div class="wBox_close"></div></td></tr></table> ') +
        ...
        function handleClick(){
			...
			if (_this.YQ.requestType && $.inArray(_this.YQ.requestType, ['iframe', 'ajax','img'])!=-1) {
                ...
                con.html("<div class='wBox_load'><div id='wBox_loading'>loading...</div></div>");
